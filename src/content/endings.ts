...
function genGlobal(version: Version): EndingDef[] {
  ...
  },
  {
    ...
    badge: '本周朝阳区第一大瓜',
    comment:
      '你同时确立了两段关系,自以为时间管理大师。直到某天,两个「官方对象」在同一家奶茶店排到了前后位,手机同时亮起同一句「在干嘛」。对质、截图、朋友圈连夜挂人——你成了本周朝阳区最大的瓜,甜度爆表,吃瓜群众管饱。',
    hint: '同时确立两段以上关系,迟早纸包不住火',
  },
  {
    id: 'pond_collapse',
    rank: 'lose',
    ...
    badge: '空塘钉子户',
    comment:
      '你曾经的鱼塘水草丰美、群鱼环绕。可你一边广撒网,一边亲手把不听话的一条条拉黑。终于某天你打开列表,才发现塘里只剩你自己的倒影。海王的尽头,是一片干涸。',
    hint: '一边并聊拉满,一边疯狂拉黑,鱼塘迟早塌',
  },
  {
    id: 'alcoholic',
    rank: 'egg',
    ...
    badge: '京城酒精依赖体验官',
    comment:
      '约会约到最后,你记住的不是对方的脸,是每一家酒吧的酒单。你在断片里表白,在宿醉里后悔,循环往复。北京的夜晚很长,幸好还有酒。医生建议你多喝热水——你把它兑进了威士忌。',
    hint: '喝得太多、断片太频,酒精会替你社交',
  },
  {
    id: 'seaking',
    rank: 'draw',
